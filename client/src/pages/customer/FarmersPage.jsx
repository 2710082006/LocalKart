...
export default function FarmersPage() {
  ...
  const savedAddress = (() => {
    try {
      return JSON.parse(localStorage.getItem("default_address") || "null");
    } catch {
      return null;
    }
  })();
  ...
  const { data, isLoading } = useQuery({
    queryKey: [
      ...
      savedAddress?.location?.coordinates,
    ],
      ...
      <div className="container">
        ...
        <div className="mb-8">
          ...
          <p className="text-neutral-500">
            Discover verified farmers near you
          </p>
        </div>
              ...
              >
                ...
                >
                  <div className="relative h-48 overflow-hidden bg-gradient-to-br from-sky-100 to-emerald-100">
                    {farmer?.coverImage?.url ? (
                      <img
                        src={farmer.coverImage.url}
                        alt={farmer?.farmName}
                      ...
                      <div>
                        ...
                        <p className="text-xs text-neutral-500">
                          {farmer?.specialties?.length
                            ? farmer.specialties.slice(0, 2).join(", ")
                            : "Fresh Produce"}
                        </p>
                      </div>
                    </div>
